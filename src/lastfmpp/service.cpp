...
service::service(std::experimental::string_view api_key, std::experimental::string_view shared_secret,
...
pplx::task<std::string> service::get_mobile_session(std::experimental::string_view username,
